...
# directly read weights here and filter unmatched layers
'''
coco_weights = torch.load(coco_weights_path)
unmatched_layers = [
...
layer_names = coco_weights.keys()
rsna_weights = model.state_dict()

for layer_name in layer_names:
    if layer_name not in unmatched_layers:
        rsna_weights[layer_name] = coco_weights[layer_name]

model.load_state_dict(rsna_weights)
'''
